...
class DataProcessor:
    ...
    def save_data(self, df, file_path):
        try:
            logger.info("Saving our data in our processed folder")

            df.to_csv(file_path, index=False)

            logger.info(f"Data saced successfully to {file_path}")
        except Exception as e:
    ...
    def process(self):
        try:
            ...
            raise CustomException("Error while data preprocesing pipeline", e)
